...
# ══════════════════════════════════════════
# TEST LOCAL — lance : python partie_evan.py
# ══════════════════════════════════════════
if __name__ == "__main__":
    ...
    with open("test_evan.html", "w", encoding="utf-8") as f:
        f.write(f"""<!DOCTYPE html>
<html><head>
<script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
</head><body style="font-family:sans-serif; padding:2rem;">
<h2>Test — partie_evan.py</h2>
{html}
</body></html>""")

    print("📄 Ouvre test_evan.html dans Chrome pour voir le résultat")
