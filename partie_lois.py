...
# ══════════════════════════════════════════
# TEST LOCAL — lance : python partie_lois.py
# ══════════════════════════════════════════
...
{html}
    ...
    print("📄 Ouvre test_lois.html dans Chrome pour voir le résultat")
